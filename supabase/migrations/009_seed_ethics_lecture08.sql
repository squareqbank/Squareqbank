...
values
  ...
  ('ethics', 'et-08', 'Confidentiality', 'Fidelity means building trust.', 'True', 'False', '', '', '', 0, 'Fidelity is about trustworthiness - being faithful, building trust, and keeping commitments and promises.', null);
